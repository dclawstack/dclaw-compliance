...
**DClaw Compliance** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8036` (FastAPI)
- **Frontend Port:** `3036` (Next.js)
- **Database:** `dclaw_compliance` (PostgreSQL)
